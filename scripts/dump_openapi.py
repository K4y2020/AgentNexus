"""Generate and post-process the agentnexus OpenAPI 3.2 document.

The agentnexus server runs on FastAPI 0.135.x, which emits OpenAPI
...
1. Imports :func:`agentnexus.server.app.create_app` and instantiates
...
# (rendered by Scalar on the agentnexus website) is usable for building
...
# Self-hosted base URL. ``agentnexus server`` binds 127.0.0.1:6767 by
...
default (`agentnexus server`); point the base URL at your own deployment.
