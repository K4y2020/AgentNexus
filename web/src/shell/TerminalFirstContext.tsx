...
//
//   - `agentnexus.wrapper === "claude-code-native-ui"` → `isClaudeNative`
//   - registered `agentnexus.wrapper` native value    → `isNativeWrapper`
//   - `agentnexus.ui === "terminal"`                  → `isTerminalFirst`
//
...
// label; runner-hosted SDK sessions now stamp `agentnexus.ui` WITHOUT a
...
export interface TerminalFirstContextValue {
  /** True when `agentnexus.wrapper === "claude-code-native-ui"`. */
  ...
  /** True when `agentnexus.ui === "terminal"` — gates the toggle + sidebar card. */
