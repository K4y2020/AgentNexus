...
export const PALETTES: readonly PaletteMeta[] = [
  {
    id: "omni",
    label: "AgentNexus",
    blurb: "Neutral surfaces for focused conversations.",
    light: {
      bg: "#fafafa",
      card: "#ffffff",
      accent: "#1a1a1a",
    ...
    dark: { bg: "#0d0d0e", card: "#141416", accent: "#f1f1ef", border: "#26262a", text: "#ececee" },
    tokens: {
      light: paletteTokens({
        background: "#fafafa",
        foreground: "#1a1a1a",
        ...
        sidebarActiveForeground: "#1a1a1a",
        sidebarBackground: "var(--sidebar)",
