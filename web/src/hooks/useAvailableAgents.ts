...
export interface AvailableAgent {
  ...
  // same-named `agentnexus run` upload, but lets a newer upload supersede a
 ...
 *   wins, so a fresh `agentnexus run agent.yaml` supersedes a stale template
