...
// against ~/.agentnexus_history). Web-side, history persists across tabs and
...
const STORAGE_PREFIX = "agentnexus:prompt-history";
 ...
 * @returns The localStorage key, e.g. ``"agentnexus:prompt-history:conv_abc123"``.
 */
