...
Core AgentNexus contributes the built-in harnesses directly. Optional community
...
COMMUNITY_ENTRY_POINT_GROUP = "agentnexus.community.harness"
COMMUNITY_MODULE_PREFIX = "agentnexus.community.harness."
...
def _builtin_native_provider(key: str) -> NativeHarnessProvider:
    ...
    """
    module = f"agentnexus.{key}_native"
    return NativeHarnessProvider(
        key=key,
        run_native=f"{module}:run_{key}_native",
        auto_create_terminal=f"agentnexus.runner.native:_launch_{key}",
...
_BUILTIN_CONTRIBUTION = HarnessContribution(
    ...
    harness_modules={
        ...
        **dict.fromkeys(ACP_CLI_HARNESSES, "agentnexus.inner.acp_harness"),
        "acp": "agentnexus.inner.acp_harness",
        # ...except a row with vendor behavior, which runs its own thin wrap to
        # inject an AcpExtension into the same shared executor.
        "devin": "agentnexus.inner.devin.harness",
        "antigravity": "agentnexus.inner.antigravity_harness",
        "antigravity-native": "agentnexus.inner.antigravity_native_harness",
        "claude-native": "agentnexus.inner.claude_native_harness",
        "claude-sdk": "agentnexus.inner.claude_sdk_harness",
        "codex": "agentnexus.inner.codex_harness",
        "codex-native": "agentnexus.inner.codex_native_harness",
        "copilot": "agentnexus.inner.copilot_harness",
        "cursor": "agentnexus.inner.cursor_harness",
        "cursor-native": "agentnexus.inner.cursor_native_harness",
        "goose": "agentnexus.inner.goose_harness",
        "goose-native": "agentnexus.inner.goose_native_harness",
        "hermes": "agentnexus.inner.hermes_harness",
        "hermes-native": "agentnexus.inner.hermes_native_harness",
        "kimi": "agentnexus.inner.kimi_harness",
        "kimi-native": "agentnexus.inner.kimi_native_harness",
        "kiro-native": "agentnexus.inner.kiro_native_harness",
        "openai-agents": "agentnexus.inner.openai_agents_sdk_harness",
        "opencode-native": "agentnexus.inner.opencode_native_harness",
        "pi": "agentnexus.inner.pi_harness",
        "pi-native": "agentnexus.inner.pi_native_harness",
        "qwen": "agentnexus.inner.qwen_harness",
        "qwen-native": "agentnexus.inner.qwen_native_harness",
    },
    aliases={
    ...
    background_title_generators={
        "claude-sdk": BackgroundTitleGeneratorSpec(
            "agentnexus.runner.background_titles.sdk:generate_background_title"
        ),
...
def harness_catalog() -> list[dict[str, object]]:
    ...
    try:
        from agentnexus.onboarding.acp_auth import acp_agents
