"""Native Kiro TUI wrapper for the AgentNexus CLI."""
...
from agentnexus._wrapper_labels import KIRO_NATIVE_WRAPPER_VALUE as _WRAPPER_LABEL_VALUE
...
_KIRO_PATH_ENV = "AGENTNEXUS_KIRO_PATH"
...
def run_kiro_native(
    *,
    ...
    """Launch the Kiro TUI in an AgentNexus terminal."""
    ...
    if server is None:
        raise click.ClickException(
            "Kiro requires a resolved AgentNexus server URL. The CLI should call "
            "_ensure_backend before run_kiro_native."
        )
    with TemporaryDirectory(prefix="agentnexus-kiro-native-") as tmpdir:
...
def _run_with_remote_server(
    ...
    *,
    ...
    """Launch Kiro on an AgentNexus server via a daemon-spawned runner."""
