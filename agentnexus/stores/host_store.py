...
from agentnexus.db.enum_codecs import decode_host_status, encode_host_status
from agentnexus.db.utils import (
    get_or_create_engine,
    make_named_managed_session_maker,
    now_epoch,
)
from agentnexus.harness_availability import HarnessAvailability, is_harness_availability
...
class Host:
    ...
    :param host_id: Stable identifier from the host's local
        ``~/.agentnexus/config.yaml``, e.g. ``"host_a1b2c3d4..."``.
...
class HostStore:
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.host_store",
        )
