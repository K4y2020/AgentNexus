...
from agentnexus.db.db_models import SqlSessionPermission, SqlUser, current_workspace_id
from agentnexus.db.utils import get_or_create_engine, make_named_managed_session_maker
from agentnexus.entities import Account, ResolvedAccess, SessionPermission
...
_RESOLVE_ACCESS_CACHE_TTL_ENV = "AGENTNEXUS_ACL_RESOLVE_CACHE_TTL_S"
_DEFAULT_RESOLVE_ACCESS_CACHE_TTL_S = 5.0
_RESOLVE_ACCESS_CACHE_MAX_ENTRIES_ENV = "AGENTNEXUS_ACL_RESOLVE_CACHE_MAX_ENTRIES"
...
class SqlAlchemyPermissionStore(PermissionStore):
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.permission_store",
        )
