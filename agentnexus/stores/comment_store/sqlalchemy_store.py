...
from agentnexus.db.db_models import SqlComment, current_workspace_id
from agentnexus.db.enum_codecs import decode_comment_status, encode_comment_status
from agentnexus.db.utils import (
    get_or_create_engine,
    make_named_managed_session_maker,
    now_epoch_us,
)
from agentnexus.entities import Comment, CommentsFingerprint
...
class SqlAlchemyCommentStore(CommentStore):
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.comment_store",
        )
