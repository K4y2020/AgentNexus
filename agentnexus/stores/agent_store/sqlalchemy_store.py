...
from agentnexus.db.enum_codecs import encode_agent_kind
...
from agentnexus.entities import Agent, PagedList
...
class SqlAlchemyAgentStore(AgentStore):
    ...
    def __init__(
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.agent_store",
        )
    ...
    def get(self, agent_id: str) -> Agent | None:
        ...
        # Runs outside the AgentNexus session: the lookup targets the AP DB.
