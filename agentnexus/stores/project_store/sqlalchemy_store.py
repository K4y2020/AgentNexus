...
from agentnexus.db.db_models import SqlProject, current_workspace_id
...
def _encode_config(config: dict[str, Any] | None) -> str | None:
    ...
    :raises AgentNexusError: ``INVALID_INPUT`` if the serialized config exceeds
...
class SqlAlchemyProjectStore(ProjectStore):
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.project_store",
        )
