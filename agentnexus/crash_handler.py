...
from agentnexus.crash_ui import real_stderr, render_crash_screen
...
_CONFIG: _CrashConfig = {
    ...
    "crashes_dir": None,
    "keep_reports": 10,
    "first_party_prefixes": ("agentnexus",),
}
...
def install_crash_handler(
    ...
    *,
    ...
    first_party_prefixes: tuple[str, ...] = ("agentnexus",),
) -> None:
    ...
    _CONFIG["first_party_prefixes"] = tuple(first_party_prefixes) or ("agentnexus",)
    ...
    *,
    ...
    try:
        ...
        render_crash_screen(
            ...
            stream=stream,
            first_party_prefixes=_CONFIG.get("first_party_prefixes", ("agentnexus",)),
        )
