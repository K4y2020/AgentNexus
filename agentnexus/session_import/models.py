...
from agentnexus.entities.conversation import synthesize_conversation_title

ImportSource = Literal["claude", "codex", "kimi", "kiro", "opencode", "pi", "qwen"]

IMPORT_SOURCE_LABEL_KEY = "agentnexus.import.source"
IMPORT_EXTERNAL_SESSION_ID_LABEL_KEY = "agentnexus.import.external_session_id"
