...
Tool policies: kimi-native enforces AgentNexus's tool deny-policy via a
...
answered in the TUI, which AgentNexus cannot intercept). Connector/tool ASK
policies are not enforced (kimi owns the ask); treat the kimi TUI as the
approval surface, with AgentNexus able to hard-deny.
"""
...
from agentnexus.inner.kimi_native_executor import KimiNativeExecutor
