"""Executor that bridges AgentNexus web-chat turns into the native Kimi TUI.
...
from agentnexus.kimi_native_bridge import BRIDGE_DIR_ENV_VAR, inject_user_message
