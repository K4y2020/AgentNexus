"""Executor that bridges AgentNexus messages into a native Pi TUI."""
...
class PiNativeExecutor(Executor):
    ...
    the AgentNexus Pi extension loaded. Each turn queues the latest user
    ...
    async def run_turn(
        ...
        :param tools: Tool schemas from AgentNexus. Ignored for now; native
