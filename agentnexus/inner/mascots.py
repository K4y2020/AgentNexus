"""Static terminal mascot art for AgentNexus startup banners."""
...
# ``omnigent.cli``. Otto's starfish magenta-pink — the AgentNexus brand accent.
...
def random_mascot_color() -> str:
    ...
    :returns: Hex color string for the AgentNexus accent,
        e.g. ``"#F43BA6"``.
    """
...
def random_mascot_lines() -> list[str]:
    ...
    mascot API, but the TUI now uses the single static AgentNexus mascot.
