...
This maps AgentNexus tool schemas onto OpenAI function tools and keeps the
...
from agentnexus.llms.adapters._content import redact_inline_data_uris
...
def _convert_tools_to_responses(tools: list[ToolSpec]) -> list[ResponsesItem]:
    """Convert AgentNexus tool schemas to Responses API function tools."""
