"""OpenTelemetry tracing integration for AgentNexus.
...
from agentnexus.runtime.telemetry import (
    parse_provider_name,
...
def enable_tracing() -> None:
    """Enable OTel tracing globally for all AgentNexus sessions."""
...
def _tracer() -> Tracer:
    ...
    return trace.get_tracer("agentnexus")
...
class TracingContext:
    ...
    def __init__(self, session_id: str | None = None) -> None:
        ...
        # AgentNexus session (conversation) id, stamped as ``session.id`` on
    ...
    def start_agent_span(
        ...
        if parent is None:
            ...
            from agentnexus.runtime.telemetry import SENTINEL_PARENT_SPAN_ID
