...
from agentnexus.runner.identity import RUNNER_AUTH_SECRET_ENV_VARS
...
_SANDBOX_STRACE_ENV = "AGENTNEXUS_SANDBOX_STRACE"
...
_LAUNCHER_WRAPPED_ENV = "AGENTNEXUS_LAUNCHER_SPAWN_WRAPPED"
...
_LAUNCHER_PRIVATE_TMPDIR_ENV = "AGENTNEXUS_LAUNCHER_SPAWN_PRIVATE_TMPDIR"
...
class SandboxBackend(ABC):
    ...
    def wrap_launcher_argv(
        ...
        :param argv: The unwrapped command argv the parent intends to
            ...
            "agentnexus.inner.os_env", "helper", "<encoded>"]``.
...
def create_private_tmpdir() -> Path:
    return Path(tempfile.mkdtemp(prefix="agentnexus-osenv-"))
    ...
    if (
        ...
        try:
            ...
            inline = (
                ...
                "from agentnexus.inner.sandbox import run_launcher; "
...
def create_exec_launcher(target_path: str, sandbox: SandboxPolicy) -> str:
    ...
    fd, path = tempfile.mkstemp(prefix="agentnexus-sandbox-", suffix=".py")
    project_root = repr(str(_project_root()))
