"""Executor that bridges AgentNexus web-chat turns into the native Goose TUI.
...
from agentnexus.goose_native_bridge import BRIDGE_DIR_ENV_VAR, inject_user_message
