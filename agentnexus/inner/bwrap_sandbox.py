...
_HOST_SANDBOX_BACKEND_ENV = "AGENTNEXUS_HOST_SANDBOX_BACKEND"
...
def _detect_host_sandbox_backend() -> str | None:
    ...
    Prefers the explicit ``AGENTNEXUS_HOST_SANDBOX_BACKEND`` env var (set by
...
class BwrapSandboxBackend(SandboxBackend):
    ...
    def wrap_launcher_argv(
        ...
        :param argv: The unwrapped helper command, typically
            ``[sys.executable, "-m", "agentnexus.inner.os_env",
            "helper", "<encoded>"]``.
