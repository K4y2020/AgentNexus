...
- ``HARNESS_CURSOR_PERMISSION_MODE``: AgentNexus permission stance
...
from agentnexus.inner.cursor_executor import CursorExecutor
...
def _resolve_os_env() -> OSEnvSpec:
    ...
    Decodes the JSON-encoded dict AgentNexus serialized via
