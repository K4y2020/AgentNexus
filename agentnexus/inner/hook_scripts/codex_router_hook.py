...
from agentnexus.codex_model_vocabulary import clamp_spawn_effort, codex_spawn_model
...
_LABEL = "agentnexus codex router hook"
_MODULE = "agentnexus.inner.hook_scripts.codex_router_hook"
