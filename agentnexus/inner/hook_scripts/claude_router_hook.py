...
from agentnexus.inner.hook_scripts.subagent_router import run_route_subagent_main

_HARNESS = "claude-native"
_LABEL = "agentnexus claude router hook"
_PROG = "agentnexus-claude-router-hook"
