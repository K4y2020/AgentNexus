...
Tool policies: AgentNexus's PreToolUse/PostToolUse policy gates (which claude- and
...
assume AgentNexus connector/tool deny-policies constrain a cursor-native session.
"""
...
from agentnexus.inner.cursor_native_executor import CursorNativeExecutor
