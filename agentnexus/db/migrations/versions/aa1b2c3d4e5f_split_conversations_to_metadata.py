...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_conversation_metadata_runner_id", table_name="agentnexus_conversation_metadata"
    )
    op.drop_index("ix_conversation_metadata_kind", table_name="agentnexus_conversation_metadata")
    op.drop_table("agentnexus_conversation_metadata")
