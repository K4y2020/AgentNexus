...
into the AgentNexus conversation with ``external_conversation_item`` events.
"""
...
from agentnexus.kiro_native_bridge import write_forwarder_ready
...
def _discover_kiro_session_jsonl(
    *,
    ...
    """Find this AgentNexus session's Kiro JSONL file — only when it's unambiguous.
...
async def _patch_external_session_id(
    ...
    *,
    ...
    """Persist Kiro's native CLI session id onto the AgentNexus session."""
