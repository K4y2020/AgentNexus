...
//
// Run with: node agentnexus/resources/pi_native/agentnexus_pi_native_extension.test.js
//
...
const EXT_PATH = path.resolve(__dirname, "agentnexus_pi_native_extension.js");
...
(async () => {
  try {
    ...
    for (const h of harnesses) {
      if (h.pi.__agentnexusInboxPoller) clearInterval(h.pi.__agentnexusInboxPoller);
      try {
