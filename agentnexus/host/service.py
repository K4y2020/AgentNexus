"""Install the AgentNexus host as a per-user operating-system service."""
...
LAUNCHD_LABEL = "ai.agentnexus.host"
SYSTEMD_UNIT = "agentnexus-host.service"
...
def _service_command(server_url: str | None) -> list[str]:
    ...
    return [sys.executable, "-m", "agentnexus.host.service_entry", *mode]
...
def _record_service(service: HostService) -> None:
    ...
    from agentnexus.install_ledger import LaunchAgentEntry, record_launch_agent
...
def _forget_service(service: HostService) -> None:
    ...
    from agentnexus.install_ledger import remove_launch_agent
