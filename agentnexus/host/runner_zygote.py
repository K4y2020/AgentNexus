...
On by default; set ``AGENTNEXUS_RUNNER_ZYGOTE=0`` to opt out. The daemon falls
...
from agentnexus.process_logging import child_logging_popen_kwargs
from agentnexus.runner._zygote import ZYGOTE_CONTROL_FD_ENV_VAR
    ...
    def wait(self, timeout: float | None = None) -> int:
        ...
        while True:
            ...
            if timeout is not None and deadline is not None and time.monotonic() >= deadline:
                raise subprocess.TimeoutExpired(cmd="agentnexus.runner._zygote", timeout=timeout)
            time.sleep(0.05)
    ...
    def _spawn_zygote_process(self, child_fd: int) -> subprocess.Popen[bytes]:
        ...
        with contextlib.ExitStack() as stack:
            ...
            return subprocess.Popen(
                ...
                [self._python, "-P", "-m", "agentnexus.runner._zygote"],
                env=env,
                pass_fds=pass_fds,
