...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="AgentNexus host service")
    mode = parser.add_mutually_exclusive_group(required=True)
    mode.add_argument("--server", help="Remote AgentNexus server URL.")
    mode.add_argument("--local", action="store_true", help="Run a local AgentNexus server.")
