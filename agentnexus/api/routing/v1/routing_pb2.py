...
# source: agentnexus/api/routing/v1/routing.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    5,
    '',
    'agentnexus/api/routing/v1/routing.proto'
)
