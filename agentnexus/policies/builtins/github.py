...
surfaces an AgentNexus agent can reach GitHub through:
...
from agentnexus.policies.builtins._shell import (
    MAX_SHELL_NESTING,
    SHELL_TOOLS,
...
def github_policy(
    *,
    ...
    :param shell_tools: Names of the shell / terminal tools whose ``command``
        ...
        — AgentNexus, Claude/Codex, Cursor, Pi, Hermes, Goose). Override this only
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    {
        ...
        "description": (
            ...
            "commands. Supports AgentNexus, Claude/Codex, Cursor, Pi, Hermes, and Goose shell "
