...
def worktree_guard(
    *,
    ...
    # Match AgentNexus built-in OS write/edit, Claude/Codex native Write/Edit
    # (surfaced via the PreToolUse hook), and Pi's native lowercase
    # write/edit (surfaced via the pi ``tool_call`` hook). Pi uses the same
    # ``path`` argument key as the AgentNexus tools, so no Pi-specific arg
...
POLICY_REGISTRY: list[dict[str, object]] = [
    {
        "handler": "agentnexus.policies.builtins.orchestration.blast_radius",
        "kind": "factory",
    ...
    {
        "handler": "agentnexus.policies.builtins.orchestration.spawn_bounds",
        "kind": "factory",
    ...
    {
        "handler": "agentnexus.policies.builtins.orchestration.headless_subagent_purpose_guard",
        "kind": "factory",
    ...
    {
        "handler": "agentnexus.policies.builtins.orchestration.worktree_guard",
        "kind": "factory",
    ...
    {
        "handler": "agentnexus.policies.builtins.orchestration.read_only_os",
        "kind": "factory",
