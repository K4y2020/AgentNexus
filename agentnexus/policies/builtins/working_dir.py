...
def block_working_dir_changes(
    *,
    ...
    :param shell_tools: Names of the shell tools whose ``command`` argument is
        ...
        (:data:`~omnigent.policies.builtins._shell.SHELL_TOOLS` — AgentNexus,
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    {
        "handler": "agentnexus.policies.builtins.working_dir.block_working_dir_changes",
        "kind": "factory",
        ...
        "description": (
            ...
            "Supports AgentNexus, Claude/Codex, Cursor, Pi, Hermes, and Goose "
