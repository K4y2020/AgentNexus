...
from agentnexus.policies.schema import PolicyEvent, PolicyResponse, StateUpdateEntry
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    ...
    {
        "handler": "agentnexus.policies.builtins.google.gmail_policy",
        "kind": "factory",
        "name": "Gmail Access",
        "description": (
    ...
    {
        "handler": "agentnexus.policies.builtins.google.gcalendar_policy",
        "kind": "factory",
