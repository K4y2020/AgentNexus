...
from agentnexus.inner._cwd_scan import _DEFAULT_DEPRIORITIZED_DIRS
from agentnexus.inner.os_env import _DEFAULT_READ_LIMIT
...
class WorkspaceReader:
    ...
    def cine_review(self, session_id: str, params: dict) -> dict:
        from agentnexus.cine_review import read_review
