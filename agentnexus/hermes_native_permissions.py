...
lives only in the TUI; to also surface it in the AgentNexus web UI (so a user can
...
from agentnexus.hermes_native_bridge import capture_hermes_pane, send_hermes_pane_keys
...
def hermes_permission_elicitation_id(session_id: str, token: str) -> str:
    """Return the deterministic AgentNexus elicitation id for a Hermes prompt.
