...
Enables built-in tools provided by agentnexus. Each entry is either a plain
...
AgentNexus may append small framework-owned lifecycle or metadata instructions
...
registration boundary (`agentnexus.cli._resolve_bundle_env_vars`), never
...
**Security note — SSRF risk:** The agentnexus server makes outbound HTTP
