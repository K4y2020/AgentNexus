...
from agentnexus.spec.types import AgentSpec, ToolRuntime
...
from agentnexus.spec._omnigent_compat import (  # noqa: E402
...
def _validate_executor_type(
    ...
    elif etype == AGENTNEXUS_EXECUTOR_TYPE:
...
def _validate_os_env(spec: AgentSpec, result: ValidationResult) -> None:
    ...
    The AgentNexus parser already enforces these on the YAML-loaded path,
    but ``AgentSpec`` may also be constructed programmatically —
    by tests, by the AgentNexus compat shim, or by future API
