"""Conversation-aware runner routing for the AgentNexus server.
...
if TYPE_CHECKING:
    ...
    from agentnexus.runner.transports.ws_tunnel.registry import RunnerSession, TunnelRegistry
...
class RunnerRouter:
    ...
    def client_for_conversation(self, *, conversation_id: str, harness: str) -> RoutedRunner:
        ...
        :raises AgentNexusError: If the conversation has no runner
        ...
        if conv is None:
            raise AgentNexusError("conversation not found", code=ErrorCode.NOT_FOUND)
        if conv.runner_id:
    ...
    def client_for_session_resources(
        ...
        *,
        ...
        :returns: Selected runner id and client.
        :raises AgentNexusError: If the conversation is missing, the
    ...
    def client_for_existing_conversation(self, conversation_id: str) -> RoutedRunner | None:
        ...
        :raises AgentNexusError: If the pinned runner is offline.
        """
        conv = self._conversation_store.get_conversation(conversation_id)
    ...
    def _routed_pinned_runner(
        ...
        :returns: Selected runner id and client.
        :raises AgentNexusError: If the runner is offline or
