...
from agentnexus.runner.background_titles.service import (
    BACKGROUND_TITLE_INFERENCE_TIMEOUT_SECONDS,
    BackgroundTitleContext,
    build_background_title_instructions,
)

_logger = logging.getLogger("agentnexus.runner.background_titles.codex_native")
...
async def generate_background_title(context: BackgroundTitleContext) -> str | None:
    ...
    from agentnexus.runner.native.orchestration import _codex_native_model_from_spec
    ...
    with tempfile.TemporaryDirectory(prefix="agentnexus-codex-title-") as temp_dir:
