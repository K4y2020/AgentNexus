...
_logger = logging.getLogger("agentnexus.runner.background_titles.claude_native")
...
async def generate_background_title(context: BackgroundTitleContext) -> str | None:
    ...
    from agentnexus.runner.native.orchestration import _claude_terminal_env_unset
