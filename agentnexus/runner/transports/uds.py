...
The CLI integration that wires `agentnexus run` to spawn both a
...
class RunnerSubprocess:
    ...
    Used by tests + Phase 2's `agentnexus run` to ship the runner as
    ...
    :param app_factory_path: Module-and-attribute path uvicorn will
        ...
        ``"agentnexus.runner.app:create_runner_app_from_env"``. Uvicorn's
    ...
    app_factory_path: str = "agentnexus.runner.app:create_runner_app_from_env"
    ...
    def __enter__(self) -> RunnerSubprocess:
        if self.socket_path is None:
            ...
            self._tmp_dir = tempfile.TemporaryDirectory(prefix="agentnexus-runner-")
