...
class _UniformInterrupt:
    ...
    :param module: The harness bridge module, e.g. ``"agentnexus.pi_native_bridge"``.
...
_UNIFORM_INTERRUPT: dict[str, _UniformInterrupt] = {
    ...
    "cursor": _UniformInterrupt(
        "agentnexus.cursor_native_bridge",
        "inject_interrupt",
    ...
    "goose": _UniformInterrupt(
        "agentnexus.goose_native_bridge",
        "inject_interrupt",
    ...
    "hermes": _UniformInterrupt(
        "agentnexus.hermes_native_bridge",
        "inject_interrupt",
...
class NativeInterruptRunner:
    ...
    async def _claude_interrupt(self, conv_id: str) -> Response:
        from agentnexus.claude_native_bridge import bridge_dir_for_bridge_id, inject_interrupt
