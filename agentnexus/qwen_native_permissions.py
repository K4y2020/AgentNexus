...
So to surface those approvals in the AgentNexus web UI (so a user on the Chat tab
...
from agentnexus.qwen_native_bridge import events_file_path, submit_confirmation
...
def qwen_permission_elicitation_id(session_id: str, request_id: str) -> str:
    """Return the deterministic AgentNexus elicitation id for a qwen control request.
