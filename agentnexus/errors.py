...
All user-facing errors should be raised as AgentNexusError with an
...
New code should prefer AgentNexusError for consistency.
"""
...
class ErrorCode:
    ...
    :cvar HARNESS_PROTOCOL_VIOLATION: A harness emitted an SSE
        sequence that violates the AgentNexus↔harness contract — e.g.
