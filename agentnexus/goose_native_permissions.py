...
``prompt_tool_confirmation``). To also surface those approvals in the AgentNexus
...
from agentnexus.goose_native_bridge import capture_goose_pane, send_goose_pane_keys
...
def goose_permission_elicitation_id(session_id: str, token: str) -> str:
    """Return the deterministic AgentNexus elicitation id for a Goose prompt.
