"""Mirror a kimi-native TUI session's transcript into the AgentNexus web chat.
...
— nothing flows the assistant's response back into AgentNexus's conversation
...
async def forward_kimi_wire_to_session(
    *,
    ...
    # host_id reads AGENTNEXUS_RUNNER_SLICE_KEY; emitted only on the workspace
