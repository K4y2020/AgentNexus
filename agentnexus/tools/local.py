...
from agentnexus_client.tools import ToolMetadata, get_tool_metadata
...
from agentnexus.tools._pep723 import parse_inline_metadata
from agentnexus.tools._srt import wrap_with_srt
