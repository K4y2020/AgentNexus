...
the same YAML produces the same tool list under AgentNexus mode and the
...
class SysCancelTaskTool(Tool):
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "NOTE: this tool only cancels tasks that AgentNexus created via "
...
class SysReadInboxTool(Tool):
    ...
    def is_async(self, arguments: str | None = None) -> bool:
        ...
        routes through :meth:`dispatch_async`, which AgentNexus awaits
