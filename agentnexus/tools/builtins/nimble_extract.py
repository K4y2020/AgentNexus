...
def _base_url() -> str:
    """Resolve the base URL; ``AGENTNEXUS_NIMBLE_EXTRACT_BASE_URL`` overrides for tests."""
    return os.environ.get("AGENTNEXUS_NIMBLE_EXTRACT_BASE_URL", _DEFAULT_BASE_URL).rstrip("/")
