...
Descriptions for the five browser tools that drive the AgentNexus
...
class BrowserNavigateTool(Tool):
    ...
    def description(cls) -> str:
        ...
        return (
            "Open or navigate the AgentNexus desktop app's embedded "
            "browser pane to a URL. Auto-opens the pane if it isn't "
            "open yet. Requires the AgentNexus desktop window to be "
