...
from agentnexus.tools.builtins.advise_models import SysAdviseModelsTool
...
from agentnexus.tools.builtins.read_skill_file import (
    ReadSkillFileTool,
)
from agentnexus.tools.builtins.scheduled_tasks import (
...
__all__ = [
    ...
    "SeedanceEditCanvasTool",
    "SeedanceReadCanvasTool",
    "SysAdviseModelsTool",
    "SysAgentDownloadTool",
    "SysAgentGetTool",
    "SysAgentListTool",
...
def _create_list_files(config: dict[str, str]) -> Tool:
    ...
    """
    from agentnexus.tools.builtins.list_files import ListFilesTool
...
def _create_hindsight_retain(config: dict[str, str]) -> Tool:
    ...
    """
    from agentnexus.tools.builtins.hindsight import HindsightRetainTool
...
def _create_hindsight_recall(config: dict[str, str]) -> Tool:
    ...
    """
    from agentnexus.tools.builtins.hindsight import HindsightRecallTool
...
def _create_hindsight_reflect(config: dict[str, str]) -> Tool:
    ...
    """
    from agentnexus.tools.builtins.hindsight import HindsightReflectTool
...
# per ``designs/AGENTNEXUS_TERMINAL_BRIDGE.md`` §3a + §6.2. Their
