...
def _perplexity_url() -> str:
    """Resolve the Perplexity URL; ``AGENTNEXUS_PERPLEXITY_BASE_URL`` overrides for tests."""
    return os.environ.get("AGENTNEXUS_PERPLEXITY_BASE_URL", _DEFAULT_PERPLEXITY_URL)
