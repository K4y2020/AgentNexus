...
class SysSessionSendTool(Tool):
    ...
    Sub-agent sessions are separate AgentNexus agent sessions (own
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "are separate AgentNexus agent sessions (own conversation, "
...
def _build_sys_session_send_schema(
    ...
    description = (
        ...
        if sub_specs
            ...
            "Child sessions are separate AgentNexus agent sessions (own "
...
class SysSessionCreateTool(Tool):
    ...
    The child is a separate AgentNexus agent session — its own
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "separate AgentNexus agent session — its own conversation, "
                    ...
                    "properties": {
                        ...
                        "config_path": {
                            ...
                            "description": (
                                ...
                                "'.agentnexus/agent-configs/helper.yaml'. "
