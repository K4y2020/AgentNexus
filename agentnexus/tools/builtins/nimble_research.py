...
Requires the optional ``nimble`` extra (``pip install 'agentnexus[nimble]'``);
...
def _base_url() -> str:
    """Resolve the base URL; ``AGENTNEXUS_NIMBLE_RESEARCH_BASE_URL`` overrides for tests."""
    return os.environ.get("AGENTNEXUS_NIMBLE_RESEARCH_BASE_URL", _DEFAULT_BASE_URL).rstrip("/")
    ...
    try:
        ...
        return (
            ...
            (
                ...
                "pip install 'agentnexus[nimble]') to use nimble_research."
            ),
        )
