...
# traffic from the AgentNexus provider is attributable.
_CLIENT_SOURCE = "agentnexus"


def _tavily_url() -> str:
    """Resolve the Tavily Search URL; ``AGENTNEXUS_TAVILY_BASE_URL`` overrides for tests."""
    return os.environ.get("AGENTNEXUS_TAVILY_BASE_URL", _DEFAULT_TAVILY_URL)
