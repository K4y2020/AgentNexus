...
points ``AGENTNEXUS_DICTATION_REMOTE_URL`` at this worker; it relays takes
...
The same ``AGENTNEXUS_DICTATION_*`` env vars configure the worker itself
...
def create_worker_app() -> FastAPI:
    ...
    app = FastAPI(title="agentnexus dictation worker")
