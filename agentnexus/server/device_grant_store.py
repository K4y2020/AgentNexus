...
from agentnexus.db.db_models import SqlDeviceGrant, current_workspace_id
from agentnexus.db.enum_codecs import decode_device_grant_status, encode_device_grant_status
from agentnexus.db.utils import get_or_create_engine, make_named_managed_session_maker
from agentnexus.entities import DeviceGrant
...
class DeviceGrantStore:
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="agentnexus.device_grant_store",
        )
