...
from agentnexus.model_fallbacks import (
...
from agentnexus.model_metadata import ModelCostTier, ModelIntent, ModelWireAPI
...
def models_in_family(harness: str | None, models: Iterable[str]) -> list[str]:
    ...
    """
    from agentnexus.runner.subagent_routing import harness_family, model_in_family
...
class ExternalRoutingClient:
    ...
    async def route(
        ...
        from agentnexus.api.routing.v1 import routing_pb2 as pb
