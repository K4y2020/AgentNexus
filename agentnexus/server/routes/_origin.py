...
- the first-party sentinel (:data:`AGENTNEXUS_INTERNAL_WS_ORIGIN`,
  ``"agentnexus://internal"``) and any origin in
  ``AGENTNEXUS_WS_ALLOWED_ORIGINS`` pass;
...
from agentnexus.server.ws_origin import origin_allowed, parse_allowed_origins
...
def require_trusted_origin(request: Request) -> None:
    ...
    (:data:`AGENTNEXUS_INTERNAL_WS_ORIGIN`), but are not required to.
