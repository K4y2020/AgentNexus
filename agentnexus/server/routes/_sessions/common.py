...
from agentnexus.db.db_models import LABEL_VALUE_MAX_LEN
from agentnexus.entities.conversation import (
    ITEM_TYPE_TO_DATA_CLS,
)
from agentnexus.harness_capabilities import ForkHistory
...
_logger = logging.getLogger("agentnexus.server.routes.sessions")
...
_ACP_SUBAGENT_ID_LABEL_KEY = "agentnexus.acp.subagent_id"


_ACP_SUBAGENT_DESCRIPTION_LABEL_KEY = "agentnexus.acp.subagent_description"


_CLAUDE_NATIVE_SUBAGENT_WRAPPER_LABEL_VALUE = "claude-code-native-ui-subagent"


_CLAUDE_NATIVE_SUBAGENT_ID_LABEL_KEY = "agentnexus.claude_native.subagent_id"


_CLAUDE_NATIVE_TOOL_USE_ID_LABEL_KEY = "agentnexus.claude_native.tool_use_id"


_CLAUDE_NATIVE_DESCRIPTION_LABEL_KEY = "agentnexus.claude_native.description"
...
_CODEX_NATIVE_SUBAGENT_THREAD_ID_LABEL_KEY = "agentnexus.codex_native.subagent_thread_id"


_CODEX_NATIVE_SUBAGENT_PARENT_THREAD_ID_LABEL_KEY = "agentnexus.codex_native.parent_thread_id"


_CODEX_NATIVE_SUBAGENT_TOOL_CALL_ID_LABEL_KEY = "agentnexus.codex_native.collab_tool_call_id"


_CODEX_NATIVE_SUBAGENT_PROMPT_LABEL_KEY = "agentnexus.codex_native.prompt"


_CODEX_NATIVE_SUBAGENT_NICKNAME_LABEL_KEY = "agentnexus.codex_native.agent_nickname"


_CODEX_NATIVE_SUBAGENT_ROLE_LABEL_KEY = "agentnexus.codex_native.agent_role"


_CODEX_NATIVE_COLLABORATION_MODE_LABEL_KEY = "agentnexus.codex_native.collaboration_mode"
...
_CLAUDE_NATIVE_PERMISSION_MODE_LABEL_KEY = "agentnexus.claude_native.permission_mode"
...
_ANTIGRAVITY_NATIVE_SUBAGENT_CASCADE_ID_LABEL_KEY = (
    "agentnexus.antigravity_native.subagent_cascade_id"
)


_ANTIGRAVITY_NATIVE_SUBAGENT_TOOL_CALL_ID_LABEL_KEY = "agentnexus.antigravity_native.tool_call_id"


_ANTIGRAVITY_NATIVE_SUBAGENT_ROLE_LABEL_KEY = "agentnexus.antigravity_native.agent_role"


_ANTIGRAVITY_NATIVE_SUBAGENT_TYPE_LABEL_KEY = "agentnexus.antigravity_native.agent_type"
...
_LAST_CONTEXT_TOKENS_LABEL_KEY: str = "agentnexus.last_context_tokens"


_LAST_CONTEXT_WINDOW_LABEL_KEY: str = "agentnexus.last_context_window"


_LAST_TASK_ERROR_CODE_LABEL_KEY: str = "agentnexus.last_task_error_code"


_LAST_TASK_ERROR_MESSAGE_LABEL_KEY: str = "agentnexus.last_task_error_message"
...
_LAST_TASK_ERROR_TITLE_LABEL_KEY: str = "agentnexus.last_task_error_title"


_LAST_TASK_ERROR_CAUSE_LABEL_KEY: str = "agentnexus.last_task_error_cause"


_LAST_TASK_ERROR_REMEDIATION_LABEL_KEY: str = "agentnexus.last_task_error_remediation"


_LAST_TASK_ERROR_LAYER_LABEL_KEY: str = "agentnexus.last_task_error_layer"
...
_CLAUDE_NATIVE_WRAPPER_LABEL_KEY = "agentnexus.wrapper"


_CLAUDE_NATIVE_WRAPPER_LABEL_VALUE = CLAUDE_NATIVE_CODING_AGENT.wrapper_label


_CLAUDE_NATIVE_UI_LABEL_KEY = "agentnexus.ui"
...
_MODEL_OPTIONS_ENDPOINT_BY_WRAPPER: dict[str, str] = {
    ...
    # (AgentNexus provider OR pi's own ``/login``) — see ``_fetch_model_options``.
}
...
def _sessions_facade() -> Any:
    ...
    import agentnexus.server.routes.sessions as facade
