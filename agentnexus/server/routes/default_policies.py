...
async def _require_admin(
    ...
    :raises AgentNexusError: 401 if unauthenticated, 403 if
        not an admin.
    """
...
def create_default_policies_router(
    ...
    async def create_policy(
        ...
        :raises AgentNexusError: 401/403 if the user lacks admin
    ...
    async def list_policies(
        ...
        :raises AgentNexusError: 401 if unauthenticated in
            multi-user mode.
        """
    ...
    async def get_policy(
        ...
        :raises AgentNexusError: 401 if unauthenticated, or
