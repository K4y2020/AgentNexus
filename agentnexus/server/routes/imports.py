...
from agentnexus.server.routes._auth_helpers import require_access, require_user
from agentnexus.server.routes._content_type import require_json_content_type
...
class ImportItemInput(BaseModel):
    """One normalized existing AgentNexus item received from the CLI."""
...
async def _stream_local_sessions_from_host(
    *,
    ...
    :raises AgentNexusError: If the host connection drops, a frame times out, or
