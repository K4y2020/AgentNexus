...
from agentnexus.server.routes._codex_elicitation import parse_codex_elicitation_request
...
from agentnexus.server.routes._origin import require_trusted_origin
...
from agentnexus.telemetry.events import SessionDeletedEvent as _TelSessionDeletedEvent
from agentnexus.telemetry.events import SessionStoppedEvent as _TelSessionStoppedEvent
from agentnexus.telemetry.installation_id import get_installation_id as _get_installation_id
from agentnexus.tools.client_specified import parse_client_side_tool_specs
...
def create_sessions_router(
    ...
    from agentnexus.server.routes.sessions.routes_agent import register_agent_routes
    from agentnexus.server.routes.sessions.routes_browser import register_browser_routes
    from agentnexus.server.routes.sessions.routes_core import register_core_routes
    from agentnexus.server.routes.sessions.routes_elicitations import register_elicitations_routes
    from agentnexus.server.routes.sessions.routes_events import register_events_routes
    from agentnexus.server.routes.sessions.routes_hooks import register_hooks_routes
    from agentnexus.server.routes.sessions.routes_items import register_items_routes
    from agentnexus.server.routes.sessions.routes_permissions import register_permissions_routes
    from agentnexus.server.routes.sessions.routes_resources import register_resources_routes
