...
from agentnexus.server.host_registry import (
    HostConnection,
    HostRegistry,
    RunnerExitReports,
)
...
def create_host_tunnel_router(
    ...
    *,
    ...
    :param local_single_user: When ``True``, allow a host to re-own a
        ...
        ``None`` (the default) resolves from ``AGENTNEXUS_LOCAL_SINGLE_USER``
        ...
        try:
            ...
            await _refuse_upgrade(
                ...
                reason=(
                    ...
                    "AGENTNEXUS_HOST_ID to a UUID (or unset it to have one "
