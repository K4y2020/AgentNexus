...
from agentnexus.db.enum_codecs import SESSION_LIVE_STATUS
...
def persist_a2a_turn_completed(
    ...
    def _record() -> None:
        ...
        if _store is not None and response_id is not None:
            from agentnexus.coordination.a2a_results import record_declared_results
            from agentnexus.coordination.workflow_auto_advance import assistant_text_from_items
