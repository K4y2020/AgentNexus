...
from agentnexus.debug_logging import debug_event, debug_sink_enabled, sse_event_logger
from agentnexus.runtime import inflight_text, pending_elicitations
...
def publish(conversation_id: str, event: dict[str, Any]) -> None:
    ...
    :param event: The event dict to publish, e.g.
        ...
        the AgentNexus route layer validates each emitted dict against
...
async def subscribe(
    ...
    *,
    ...
    # registration, before the ``yield`` below suspends. On the AgentNexus event
