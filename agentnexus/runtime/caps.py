...
if TYPE_CHECKING:
    ...
    from agentnexus.server.smart_routing import RoutingClient, RoutingSettings
    from agentnexus.spec.types import LLMConfig, PolicySpec
...
class RuntimeCaps:
    ...
    :param sandbox_enabled: Whether to use ``srt`` sandboxing for
        ...
        ``AGENTNEXUS_CONTAINER_RUNTIME`` environment variable; the
