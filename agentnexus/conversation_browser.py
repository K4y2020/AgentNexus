"""Helpers for opening AgentNexus conversation URLs from CLI frontends."""
...
from agentnexus.server_url import WORKSPACE_UI_PATH, ServerUrl
...
def conversation_url(base_url: str, conversation_id: str) -> str:
    """
    Build the browser URL for an AgentNexus conversation.
...
SESSION_URL_ANNOUNCE_PREFIX = "AgentNexus session: "
...
def announce_conversation_url(
    *,
    ...
    greppable ``"AgentNexus session: <url>"`` line so headless callers (CI
