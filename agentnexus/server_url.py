"""The one representation of an AgentNexus server URL.

An AgentNexus server is addressed by two related but distinct URLs:
...
class ServerUrl:
    """An AgentNexus server URL: canonical API base plus workspace selector.
    ...
    def from_api_base(cls, api_base: str) -> ServerUrl:
        ...
        from agentnexus.cli_auth import load_databricks_org_id
...
def display_server_url(base_url: str) -> str:
    """Map an AgentNexus server base URL to the user-facing form to show.
