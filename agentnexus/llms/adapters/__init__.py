...
def get_adapter(provider: str, **kwargs: Any) -> BaseAdapter:
    ...
    :raises AgentNexusError: If the provider is not supported.
    """
...
def _create_adapter(provider: str, **kwargs: Any) -> BaseAdapter:
    ...
    if provider == "anthropic":
        from agentnexus.llms.adapters.anthropic import AnthropicAdapter
    ...
    if provider == "bedrock":
        from agentnexus.llms.adapters.bedrock import BedrockAdapter
