...
from agentnexus.model_metadata import ModelMetadata, ModelReasoningMode
from agentnexus.reasoning_effort import ANTHROPIC_EFFORTS, validate_effort_or_llm_error
...
def _build_headers(
    ...
    :raises AgentNexusError: If no API key is provided.
    """
