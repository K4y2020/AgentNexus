...
optional dependency (``pip install 'agentnexus[boxlite]'``) imported lazily, so
...
HOST_IMAGE_ENV_VAR: str = "AGENTNEXUS_BOXLITE_HOST_IMAGE"
...
SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "AGENTNEXUS_BOXLITE_SANDBOX_ENV"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `pip install 'agentnexus[boxlite]'`. Local mode also "
