...
(``pip install 'agentnexus[daytona]'``) imported lazily, so the provider
...
HOST_IMAGE_ENV_VAR: str = "AGENTNEXUS_DAYTONA_HOST_IMAGE"
...
SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "AGENTNEXUS_DAYTONA_SANDBOX_ENV"
...
# AgentNexus host must survive arbitrary idle gaps between turns, so
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "provider. Install it with `pip install 'agentnexus[daytona]'`, "
