...
dependency (``uv pip install 'agentnexus[openshell]'``) imported lazily, so
...
- **Custom host image.** AgentNexus boots its prebaked host image, which
...
HOST_IMAGE_ENV_VAR: str = "AGENTNEXUS_OPENSHELL_HOST_IMAGE"
"""Environment variable overriding :data:`DEFAULT_HOST_IMAGE` for
OpenShell sandboxes."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "AGENTNEXUS_OPENSHELL_SANDBOX_ENV"
...
WORKSPACE_ENV_VAR: str = "AGENTNEXUS_OPENSHELL_WORKSPACE"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `uv pip install 'agentnexus[openshell]'`, then select a "
