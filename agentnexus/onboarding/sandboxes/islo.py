...
AgentNexus's bootstrap needs interactive streaming output.
...
- **Prebaked host image.** Like Modal and Daytona, sandboxes boot from
  the official AgentNexus host image unless overridden. That keeps
...
HOST_IMAGE_ENV_VAR: str = "AGENTNEXUS_ISLO_HOST_IMAGE"
"""Environment variable overriding :data:`DEFAULT_HOST_IMAGE` for Islo
sandboxes."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "AGENTNEXUS_ISLO_SANDBOX_ENV"
