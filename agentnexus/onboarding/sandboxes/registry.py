...
Core AgentNexus contributes built-in sandbox providers directly. Optional
...
from agentnexus.onboarding.sandboxes.base import SandboxHostLauncher

logger = logging.getLogger(__name__)

COMMUNITY_ENTRY_POINT_GROUP = "agentnexus.sandbox_providers"
COMMUNITY_MODULE_PREFIX = "agentnexus.community.sandbox."
...
class SandboxProviderContribution:
    ...
    :param name: Package / contributor name, e.g. ``"agentnexus-acme"``. Used
...
def _builtin_contribution() -> SandboxProviderContribution:
    """The built-in sandbox-provider contribution from core AgentNexus."""
    return SandboxProviderContribution(
        name="agentnexus",
        providers={
            "lakebox": SandboxProviderMetadata(
                name="lakebox",
                launcher_class="agentnexus.onboarding.sandboxes.lakebox:LakeboxLauncher",
            ),
            "modal": SandboxProviderMetadata(
                name="modal",
                launcher_class="agentnexus.onboarding.sandboxes.modal:ModalSandboxLauncher",
                managed_token_ttl_s=25 * 3600,
            ),
            "daytona": SandboxProviderMetadata(
                name="daytona",
                launcher_class="agentnexus.onboarding.sandboxes.daytona:DaytonaSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
            "blaxel": SandboxProviderMetadata(
                name="blaxel",
                launcher_class="agentnexus.onboarding.sandboxes.blaxel:BlaxelSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
            "boxlite": SandboxProviderMetadata(
                name="boxlite",
                launcher_class="agentnexus.onboarding.sandboxes.boxlite:BoxliteSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
            "cwsandbox": SandboxProviderMetadata(
                name="cwsandbox",
                launcher_class="agentnexus.onboarding.sandboxes.cwsandbox:CWSandboxLauncher",
            ),
            "islo": SandboxProviderMetadata(
                name="islo",
                launcher_class="agentnexus.onboarding.sandboxes.islo:IsloSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
            "e2b": SandboxProviderMetadata(
                name="e2b",
                launcher_class="agentnexus.onboarding.sandboxes.e2b:E2BSandboxLauncher",
            ),
            "openshell": SandboxProviderMetadata(
                name="openshell",
                launcher_class="agentnexus.onboarding.sandboxes.openshell:OpenShellSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
            "kubernetes": SandboxProviderMetadata(
                name="kubernetes",
                launcher_class="agentnexus.onboarding.sandboxes.kubernetes:KubernetesSandboxLauncher",
                managed_token_ttl_s=7 * 24 * 3600,
            ),
        },
    )
