...
from agentnexus.onboarding.harness_install import GOOSE_KEY, harness_cli_installed
...
def _goose_binary() -> str | None:
    """Resolve the goose executable (``AGENTNEXUS_GOOSE_PATH`` override, else PATH)."""
