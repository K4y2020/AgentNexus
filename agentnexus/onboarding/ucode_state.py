...
AgentNexus reads this file to pick per-harness model defaults, base URLs,
...
def read_ucode_state(workspace_url: str) -> UcodeWorkspaceState | None:
    ...
    state-version changes; it validates the keys AgentNexus consumes rather
