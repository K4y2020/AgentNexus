...
import agentnexus.onboarding.gemini_auth as _gemini_auth
import agentnexus.onboarding.kimi_auth as _kimi_auth
from agentnexus._platform import resolve_cli_binary
from agentnexus.harness_aliases import HARNESS_ALIASES, canonicalize_harness
...
from agentnexus.harness_plugins import harness_install_keys, valid_harnesses
...
# auth backend and no AgentNexus provider family, so readiness is binary presence.
...
def _cli_family_availability(canonical: str, install_key: str) -> HarnessAvailability:
    ...
    from agentnexus.onboarding.harness_install import harness_cli_logged_in
...
def _harness_availability(canonical: str) -> HarnessAvailability:
    ...
    if _is_codex_family_harness(canonical):
        from agentnexus.codex_native import _codex_auth_unavailable_reason
