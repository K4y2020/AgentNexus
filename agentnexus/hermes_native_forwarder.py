...
only surface that reflects the agent's work — the AgentNexus conversation view (chat
...
from agentnexus import hermes_native_status
...
async def forward_hermes_store_to_session(
    *,
    ...
    # AgentNexus server so we do it at most once per forwarder lifetime.
