...
on the shared AgentNexus server.

Layout (per conversation):

    ~/.agentnexus/codex-native/<sha256(conv_id)[:32]>/launch.json
"""
...
_STATE_ROOT_ENV_VAR = "AGENTNEXUS_CODEX_NATIVE_STATE_DIR"
...
def _codex_native_state_root() -> Path:
    ...
    setups. Otherwise follows ``AGENTNEXUS_DATA_DIR``, falling back to
