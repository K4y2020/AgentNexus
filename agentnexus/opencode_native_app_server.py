...
is runner-internal — the web UI attaches to AgentNexus terminal resources,
...
# try an as-yet-unvalidated 1.18+/v2 release). Mirrors AGENTNEXUS_NO_UPDATE_CHECK.
_SKIP_VERSION_CHECK_ENV = "AGENTNEXUS_OPENCODE_SKIP_VERSION_CHECK"
...
def list_opencode_cli_model_options(
    *,
    ...
    AgentNexus picker and fall back to the server API if it fails.
...
def filtered_server_env(
    *,
    ...
    :param extra_env: Additional provider env (e.g. from AgentNexus setup).
