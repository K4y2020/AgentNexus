...
(async () => {
  ...
  r = await run({ files: ["agentnexus/db/x.py"], load: { SabhyaC26: 1 } });
  ...
  r = await run({
    files: ["agentnexus/inner/a.py", "agentnexus/tools/b.py"],
  ...
  r = await run({ files: ["agentnexus/inner/foo.py"], fork: false });
  ...
  r = await run({ files: ["agentnexus/inner/foo.py"], author: "dhruv0811" });
