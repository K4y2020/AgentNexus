...
2. Dispatch each task to `claude_code`, `codex`, `opencode`, `cursor`, `agy`, or `pi`:
   ...
   third lens is wanted. Do not include `args.model`; worker models come from
   the user's Bot settings and the runtime.
