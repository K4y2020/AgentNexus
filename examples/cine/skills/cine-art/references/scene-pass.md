...
| 空景 | 人是另一层资产（cine-characters 管），环境参考图里有人，一致性全毁 |
...
5. **风格整套取用。**跑 `node scripts/cine-art.mjs styles` 拿当前风格的 render/surface/negative/tags，`image.sheet` 里整段带上渲染句和表面处理句，不要混搭两种风格。
