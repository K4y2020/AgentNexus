...
from omnigent.db.db_models import SqlAgentMemory, current_workspace_id
...
class SqlAlchemyAgentMemoryStore(AgentMemoryStore):
    """Persist teammate memories in the Omnigent database."""
    ...
    def __init__(self, storage_location: str) -> None:
        ...
        self._session = make_named_managed_session_maker(
            self._engine,
            query_name_prefix="omnigent.agent_memory_store",
        )
