...
A2A_CHANNEL_LABEL = "omnigent.teammate.channel"
A2A_CHANNEL_SCOPE_LABEL = "omnigent.teammate.channel_scope"
A2A_CHANNEL_KIND_LABEL = "omnigent.teammate.channel_kind"
A2A_CHANNEL_SOURCE_LABEL = "omnigent.teammate.channel_source"
