...
from agentnexus.policies.function import FunctionPolicy, _build_event
from agentnexus.policies.types import EvaluationContext, PolicyLLMClient
...
def test_resolve_server_llm_connection_resolves_databricks_profile(
    ...
    monkeypatch.setattr(
        "agentnexus.runtime.policies.builder.resolve_databricks_workspace",
