...
from agentnexus.runtime.tool_retry import (
    call_tool_with_timeout,
    execute_tool_with_retry,
    resolve_tool_retry,
    resolve_tool_timeout,
)
from agentnexus.spec.types import RetryPolicy, ToolsConfig
...
def test_execute_tool_with_retry_retries_on_timeout(
    ...
    monkeypatch.setattr("agentnexus.runtime.tool_retry.time.sleep", lambda _: None)
    ...
    monkeypatch.setattr(
        "agentnexus.runtime.tool_retry.call_tool_with_timeout",
