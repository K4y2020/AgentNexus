"""Tests for the AgentNexus brand wordmark and Otto lockup."""
...
from agentnexus.inner import wordmark
from agentnexus.inner.mascots import MASCOT_ART_COLOR, MASCOT_ART_LINES
