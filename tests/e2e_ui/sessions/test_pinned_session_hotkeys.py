...
``window.agentnexusDesktop.kind === "electron"`` — see
...
exercise it end-to-end we inject a minimal ``window.agentnexusDesktop`` stub
...
# `window.agentnexusDesktop?.kind === "electron"`) sees a native shell. Every
