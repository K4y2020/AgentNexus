...
"agentnexus-python-callable"``) store a DOTTED IMPORT PATH in the same
...
from agentnexus.runner.app import _spec_with_workdir_paths
...
@pytest.mark.parametrize("language", ["agentnexus-python-callable", "python", None])
