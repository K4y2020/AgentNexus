...
async def test_auto_create_pi_terminal_threads_spec_model_into_models_json(
    ...
    import agentnexus.pi_native_credentials as creds
    ...
    monkeypatch.setattr("agentnexus.pi_native.resolve_pi_executable", lambda: "/usr/bin/pi")
    ...
    entry = models["providers"]["agentnexus"]["models"][0]
