...
and the auto-recorder that activates when ``AGENTNEXUS_TOKEN_USAGE_JSON``
is set.
"""
...
async def test_client_notify_records_with_active_test(
    ...
    from agentnexus.llms.client import Client, _ResponsesNamespace
    from agentnexus.llms.types import MessageOutput, OutputText, Response, Usage
