...
from agentnexus.llms.adapters.openai import (
    OpenAIAdapter,
    OpenAICompatibleAdapter,
    _parse_sse_line,
)
from agentnexus.llms.types import ResponseTextDeltaEvent
...
def test_resolve_base_url_override_wins() -> None:
    from agentnexus.llms.adapters.openai import _resolve_base_url
...
def test_resolve_base_url_raises_when_both_none() -> None:
    ...
    with pytest.raises(AgentNexusError, match="base_url"):
...
def test_to_responses_tools_flattens_chat_format() -> None:
    from agentnexus.llms.adapters.openai import _to_responses_tools
...
def test_parse_responses_output_message() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_output
    from agentnexus.llms.types import MessageOutput
...
def test_parse_responses_output_native_tool() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_output
    from agentnexus.llms.types import NativeToolOutput
...
def test_parse_responses_response_full() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_response
    from agentnexus.llms.types import MessageOutput, Usage
...
def test_parse_responses_response_missing_model_raises() -> None:
    ...
    with pytest.raises(AgentNexusError, match="model"):
...
def test_parse_responses_event_text_delta() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import ResponseTextDeltaEvent
...
def test_parse_responses_event_reasoning_delta() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import ResponseReasoningTextDeltaEvent
...
def test_parse_responses_event_reasoning_summary_delta() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import ResponseReasoningSummaryTextDeltaEvent
...
def test_parse_responses_event_reasoning_started() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import ResponseReasoningStartedEvent
...
def test_parse_responses_event_native_tool_done() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import NativeToolOutputAddedEvent
...
def test_parse_responses_event_completed() -> None:
    from agentnexus.llms.adapters.openai import _parse_responses_event
    from agentnexus.llms.types import ResponseCompletedEvent
