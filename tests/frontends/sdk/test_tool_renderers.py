...
from agentnexus_ui_sdk.terminal._tool_renderers import (
...
def test_formatter_uses_specialized_tool_renderer() -> None:
    ...
    from agentnexus_client._blocks import ToolGroup
...
def test_formatter_result_block_preserves_arguments_for_edit_diff() -> None:
    ...
    from agentnexus_client._blocks import ToolResultBlock
    from agentnexus_ui_sdk.terminal._formatter import RichBlockFormatter
...
def test_formatter_native_tool_specialized() -> None:
    ...
    from agentnexus_client._blocks import NativeToolBlock
    from agentnexus_ui_sdk.terminal._formatter import RichBlockFormatter
