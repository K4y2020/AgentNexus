...
they got the copied AgentNexus transcript as context but not Codex's
...
pytestmark = pytest.mark.skipif(
    ...
    reason=("codex-native fork e2e needs `codex` on PATH and AGENTNEXUS_E2E_CODEX_NATIVE=1 to run"),
)
