...
@pytest.mark.parametrize(
    "line",
    [
        'patch("agentnexus.tools.mcp.asyncio.sleep")',
        'mock.patch("agentnexus.tools.mcp.asyncio.sleep", new_callable=AsyncMock)',
        'monkeypatch.setattr("agentnexus.llms.client.asyncio.sleep", _fake)',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'patch("agentnexus.tools.mcp._sleep", new_callable=AsyncMock)',
...
def test_main_exit_codes(tmp_path: Path) -> None:
    ...
    dirty.write_text('patch("agentnexus.x.asyncio.sleep")\n')
    clean = tmp_path / "test_clean.py"
    clean.write_text('patch("agentnexus.x._sleep")\n')
