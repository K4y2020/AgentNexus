...
Cover the onboarding helpers used by ``agentnexus setup``: env-var hygiene
...
from agentnexus.onboarding import setup as setup_mod
from agentnexus.onboarding.setup import (
...
def test_maybe_run_skips_when_skip_env_set(monkeypatch: pytest.MonkeyPatch) -> None:
    """``AGENTNEXUS_SKIP_ONBOARD=1`` short-circuits before any side effects."""
