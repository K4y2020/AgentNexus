...
@pytest.mark.parametrize(
    ...
    [
            ...
            [
                {
                    "type": "input_text",
                    "text": (
                        "[Attached: /tmp/agentnexus/claude-native/0a1b/uploads/shot.png]"
                        "\n\nfix this layout bug"
                    ),
                }
            ],
        ...
        (
            [
                {"type": "input_text", "text": "[Attached file: /tmp/agentnexus/u/report.bin]"},
        ...
        (
            [{"type": "input_text", "text": "[Attached: /tmp/agentnexus/u/img.png]"}],
            None,
        ),
