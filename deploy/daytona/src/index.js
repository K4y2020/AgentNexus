// AgentNexus <-> Daytona egress relay.
//
...
// upgrades alike) to the real AgentNexus server, so the in-sandbox host's
...
export default {
  async fetch(request, env) {
    ...
    // X-AgentNexus-Host-Token and the WebSocket Upgrade), and body.
