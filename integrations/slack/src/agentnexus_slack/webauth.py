...
The state signing/verification lives in :mod:`agentnexus_slack.enrollment_state`;
the OAuth client in :mod:`agentnexus_slack.databricks_oauth`. See
...
def _success_page(*, server_url: str, idp_email: str, slack_email: str, team_name: str) -> str:
    ...
    message = (
        ...
        "this, run <code>/agentnexus logout</code> in Slack."
    )
